...
public class EnumTest {
  ...
  void testThrowsIllegalArgumentExceptionWhenDoesNotContainSuchConstant() {
    ...
    assertEquals("No enum constant enumtest.io.github.farrukhjon.experiment.java.LevelE.FOURTH", exception.getMessage());
  }
  ...
  void testThrowsIllegalArgumentExceptionWhenDoesNotContainSuchConstantEmptyCase() {
    ...
    assertNotNull(exception);
    assertEquals("No enum constant enumtest.io.github.farrukhjon.experiment.java.LevelE.", exception.getMessage());
  }
