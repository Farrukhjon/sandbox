package io.github.farrukhjon.experiment.java.checktwoarraysequalsmismatch;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Comparators
        Comparator<Melon> byTypeComparator = Comparator.comparing(Melon::getType);
        Comparator<Melon> byWeightComparator = Comparator.comparing(Melon::getWeight);
