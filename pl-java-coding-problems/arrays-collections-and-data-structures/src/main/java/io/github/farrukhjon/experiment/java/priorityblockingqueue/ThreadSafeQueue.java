package io.github.farrukhjon.experiment.java.priorityblockingqueue;
...
public class ThreadSafeQueue {
    ...
    private static final Logger logger = Logger.getLogger(io.github.farrukhjon.experiment.java.synchronousqueue.ThreadSafeQueue.class.getName());
