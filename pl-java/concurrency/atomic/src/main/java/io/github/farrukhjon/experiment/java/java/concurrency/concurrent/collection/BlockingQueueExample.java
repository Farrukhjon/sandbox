package io.github.farrukhjon.experiment.java.java.concurrency.concurrent.collection;
...
public class BlockingQueueExample {
    ...
    private static class BlockingQueueConsumer implements Runnable {
        ...
        public static final String BLOCKING_QUEUE_TAKE = "blockingQueue.take(): ";
        ...
        public void run() {
            try {
                System.out.println(BLOCKING_QUEUE_TAKE + blockingQueue.take());
                System.out.println(BLOCKING_QUEUE_TAKE + blockingQueue.take());
                System.out.println(BLOCKING_QUEUE_TAKE + blockingQueue.take());
