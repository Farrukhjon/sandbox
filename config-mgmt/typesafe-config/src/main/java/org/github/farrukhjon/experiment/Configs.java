package org.github.farrukhjon.experiment;
...
public class Configs {
  ...
  public static Map<String, Object> asMap(Config config) {
    return Seq.seq(config.entrySet())
        .toMap(Map.Entry::getKey, e -> e.getValue().unwrapped());
  }
  ...
  public static void main(String[] args) {
    //final ConfigObject config = ConfigFactory.load().root();
    final Config config = newBuilder()
