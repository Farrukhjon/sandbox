package io.github.farrukhjon.experiment.java.completablefuture.composecombine;
...
public final class CustomerAsyncs {
    ...
    private static final Logger logger = Logger.getLogger(io.github.farrukhjon.experiment.java.completablefuture.CustomerAsyncs.class.getName());
