package io.github.farrukhjon.experiment.java.filtercollectionbylist;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<io.github.farrukhjon.experiment.java.sortarray.Melon> melons = new ArrayList<>(ARRAY_SIZE);
        for (int i = 0; i < ARRAY_SIZE; i++) {
            melons.add(new io.github.farrukhjon.experiment.java.sortarray.Melon(
        ...
        List<io.github.farrukhjon.experiment.java.sortarray.Melon> resultsV1 = new ArrayList<>();
        for (io.github.farrukhjon.experiment.java.sortarray.Melon melon : melons) {
        ...
        List<io.github.farrukhjon.experiment.java.sortarray.Melon> resultsV2 = melons.stream()
