package io.github.farrukhjon.experiment.java.findelementinarray;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        io.github.farrukhjon.experiment.java.sortarray.Melon[] melons = new io.github.farrukhjon.experiment.java.sortarray.Melon[]{
            new io.github.farrukhjon.experiment.java.sortarray.Melon("Crenshaw", 2000), new io.github.farrukhjon.experiment.java.sortarray.Melon("Gac", 1200), new io.github.farrukhjon.experiment.java.sortarray.Melon("Bitter", 2200)};

        // Comparators
        Comparator<io.github.farrukhjon.experiment.java.sortarray.Melon> byType = Comparator.comparing(
            io.github.farrukhjon.experiment.java.sortarray.Melon::getType);
        ...
        boolean found4 = ArraySearch.containsElementObjectV1(melons.clone(), new io.github.farrukhjon.experiment.java.sortarray.Melon("Gac", 1200));
        ...
        boolean found5 = ArraySearch.containsElementObjectV2(melons.clone(), new io.github.farrukhjon.experiment.java.sortarray.Melon("Gac", 1205), byType);
        ...
        boolean found6 = ArraySearch.containsElementObjectV3(melons.clone(), new io.github.farrukhjon.experiment.java.sortarray.Melon("Honeydew", 1200), byWeight);
        ...
        int index3 = ArraySearch.findIndexOfElementObjectV1(melons.clone(), new io.github.farrukhjon.experiment.java.sortarray.Melon("Gac", 1200));
        ...
        int index4 = ArraySearch.findIndexOfElementObjectV2(melons.clone(), new io.github.farrukhjon.experiment.java.sortarray.Melon("Gac", 1205), byType);
