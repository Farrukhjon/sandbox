...
console.log('// Operands of different types are weakly equal')
console.log('\'42\' == 42:', '42' == 42) // true — even different types

// checks both type and value, since undefined and null are of different types (from the typeof Operator section),
