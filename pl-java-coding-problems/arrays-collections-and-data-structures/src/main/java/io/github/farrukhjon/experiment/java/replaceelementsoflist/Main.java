package io.github.farrukhjon.experiment.java.replaceelementsoflist;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < copyOfMelons1.size(); i++) {
            if (copyOfMelons1.get(i).getWeight() < 3000) {
                copyOfMelons1.set(i, new io.github.farrukhjon.experiment.java.sortarray.Melon(copyOfMelons1.get(i).getType(), 3000));
            }
        }
        ...
        UnaryOperator<io.github.farrukhjon.experiment.java.sortarray.Melon> operator
