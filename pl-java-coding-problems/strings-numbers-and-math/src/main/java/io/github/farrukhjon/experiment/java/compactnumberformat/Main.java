package io.github.farrukhjon.experiment.java.compactnumberformat;
...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println("Parsing & io.github.farrukhjon.experiment.java.grouping (short) 5,50K: " + fiveSGThousand);
        System.out.println("Parsing & io.github.farrukhjon.experiment.java.grouping (long) 5,50 thousand: " + fiveLGThousand);
    }
}
