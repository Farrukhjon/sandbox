package io.github.farrukhjon.experiment.java.absentpresentinmap;
...
public class AbsentPresentInMap {
    ...
    public static void main(String[] args) throws UnknownHostException, IOException {
        ...
        BiFunction<String, String, String> jdbcUrlFn
            = (k, v) -> "jdbc:" + k + "://" + v + "/customers_db";

        String mySqlJdbcUrl1 = map1.computeIfPresent("mysql", jdbcUrlFn);
        ...
        Function<String, String> jdbcUrl2Fn
            = k -> k + "://" + address + "/customers_db";

        String mongodbJdbcUrl = map2.computeIfAbsent("mongodb", jdbcUrl2Fn);
        ...
        BiFunction<String, String, String> jdbcUrlFn3 = (k, v) -> "jdbc:" + k + "://"
            + ((v == null) ? address : v) + "/customers_db";

        String mysqlJdbcUrl = map3.compute("mysql", jdbcUrlFn3);
        String derbyJdbcUrl = map3.compute("derby", jdbcUrlFn3);
